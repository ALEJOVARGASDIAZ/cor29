      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#contacto">
            <Button
              size="lg"
              className="bg-white text-primary hover:bg-white/90 font-bold text-lg px-10 py-7 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
          ...
          >
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white/30 bg-white/10 text-white hover:bg-white/20 font-semibold text-lg px-10 py-7 rounded-xl backdrop-blur-sm"
            >
